...
2. In VSCode, open the command palette (`cmd+shift+p`) and type `Extensions: Install from VSIX ...`, or click "Install from VISX" from the extensions sidebar.
...
* Update vsce to @vscode/vsce. VSCE was deprecated and may have broken the functionality of the extension for newer versions of vscode.
